...
public class Gestao {
    ...
    public static void main(String[] args) {
        try {
            pratos = carregaPratos("src/main/java/uff/ic/lleme/tcc00328/s20211/prova/p1/RafaelDeSousaSalgado/Questao1/pratos.txt");
            pedidos = carregaPedidos("src/main/java/uff/ic/lleme/tcc00328/s20211/prova/p1/RafaelDeSousaSalgado/Questao1/pedidos.txt");
    ...
    private static Prato[] carregaPratos(String arq) throws
        ...
        while (in.hasNext()) {
            ...
            for (int i = 0; i < dados.length; i++)
                switch (i) {
                    case 0 ->
                        valor = Float.parseFloat(dados[i]);
                    case 1 ->
                        nome = dados[i];
                    default -> {
                        nome = nome.concat(" ");
    ...
    private static Pedido[] carregaPedidos(String arq) throws
            FileNotFoundException {
        InputStream input = new FileInputStream(arq);
        Scanner in = new Scanner(input);
        String nome = "";
